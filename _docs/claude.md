...
- **[fix/algorithm] Sodium Hard Cap:** Vá lỗ hổng "Điểm mù Natri" trong Food Scoring bằng Double Medical Protection (Cap 60 cho density mặn, Cap 40 cho độ mặn cực đoan hoặc tổng muối > 1000mg/khẩu phần).
...
- **[feat/ui] Lean Protein Alternatives UI:** Nâng cấp hiển thị gợi ý protein nạc trong `MealResult.jsx` — từ danh sách text đơn giản thành card trực quan có tỷ lệ mỡ/đạm và nút "Swap ngay" (⚡) mở thẳng IngredientSwapModal cho slot protein, giúp người dùng xử lý lỗi NEGATIVE_WEIGHT nhanh chóng.
